...
public class Save_Client {
	...
	//AUTO
		public static void savejson_client() {
	        ...
	        try {
	            PATH = new java.io.File(".").getCanonicalPath()
	                    + "/src/Users/Modules/User/Model/Files/Client/Files_Client/json/client.json";
	        } catch (IOException e) {
	            e.printStackTrace();
	        }
		...
		public static void savexml_client() {
	        ...
	        try {
	            PATH = new java.io.File(".").getCanonicalPath()
	                    + "/src/Users/Modules/User/Model/Files/Client/Files_Client/xml/client.xml";
	        } catch (IOException e) {
	            e.printStackTrace();
	        }
		...
		public static void savetxt_client() {
	        ...
	        try {
	            PATH = new java.io.File(".").getCanonicalPath()
	                    + "/src/Users/Modules/User/Model/Files/Client/Files_Client/txt/client.txt";
	        } catch (IOException e) {
	            e.printStackTrace();
	        }
