...
public class Functions_delete {
	public static void delete_admin () {
		...
		if(Singleton.useradmin.isEmpty()){
			...
			menu = functions.menuo(menu_print, lenguage.getInstance().getProperty("read_message"), "Delete");
			switch (menu){
			case 0:				
			...
			if (location != -1) {
				...
				JOptionPane.showMessageDialog(null, lenguage.getInstance().getProperty("deleteuser"));
			}else {
